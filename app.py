"""Pump Diagnostic System - Pertamina Patra Niaga (3-Layer Architecture Final)"""
...
# ============================================
# SECTION 2: Layer 1 - Overall Screening
# ============================================
...
# ============================================
# SECTION 3: Layer 2 - FFT Spectrum Analysis (Conditional)
# ============================================
# Initialize session state for anomaly detection
if 'layer1_anomaly' not in st.session_state:
    st.session_state.layer1_anomaly = False

# Only show Layer 2 inputs if anomaly detected in Layer 1
if st.session_state.layer1_anomaly:
    st.markdown('<p class="section-header">3. Layer 2: FFT Spectrum Analysis (Conditional - Only for Anomalous Points)</p>', unsafe_allow_html=True)
    st.info("""
    🔍 **FFT Spectrum Structure**:
    • Radial spectra: 4 bearings (B1-B4) × Horizontal direction × 3 peaks = 12 peaks
    • Axial spectra: 2 locations (B1 & B3) × 3 peaks = 6 peaks
    • Total: 18 peaks → 36 input values (frekuensi + amplitudo)
    """)
...
# ============================================
# SECTION 4: Layer 3 - Advanced Tests (Conditional)
# ============================================
if st.session_state.layer1_anomaly:
    st.markdown('<p class="section-header">4. Layer 3: Advanced Tests (Conditional - Only if Unbalance Detected)</p>', unsafe_allow_html=True)
...
# ============================================
# SECTION 5: Generate Diagnosis Button
# ============================================
if st.button("🔍 GENERATE DIAGNOSIS", type="primary", use_container_width=True, key="diagnose_btn"):
    with st.spinner("Menganalisis data dengan arsitektur 3-layer..."):
        ...
        # Update session state for conditional rendering
        st.session_state.layer1_anomaly = layer1_anomaly
...
"""
            ...
            st.markdown("""
            <div class="footer">
            <p><strong>Pump Diagnostic System v3.1</strong> | Pertamina Patra Niaga - Asset Integrity Management</p>
